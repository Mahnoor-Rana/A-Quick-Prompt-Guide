# <strong> Prompt Guide </strong>
 ...
 <strong> The notebook provides clear definitions and guidelines of the principles for using it.Compose a prompt that is struct effectively and encourages a meaningful responses.
</strong><br>