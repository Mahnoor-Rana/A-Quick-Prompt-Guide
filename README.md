# <strong> Prompt Guide </strong>
 ...
 <strong> The notebook provides clear definitions and guidelines of the principles for using it.After  understanding that principles you  write effective prompt.
</strong><br>